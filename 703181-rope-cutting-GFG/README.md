# [Rope Cutting](https://www.geeksforgeeks.org/problems/rope-cutting3334/1?utm=codolio)
## Easy
...
Output : [9, 7, 5, 3, 2, 1]Explanation: In the first operation, the minimum ropes are 1 So, we reduce length 1 from all of them after reducing we left with 9 ropes and so on.

# [Sort in specific order](https://www.geeksforgeeks.org/problems/sort-in-specific-order2422/1?utm=codolio)
## Medium
...
Output: [7, 5, 3, 1, 0, 2, 4]Explanation: 7, 5, 3, 1 are odd numbers in descending order and 0, 2, 4 are even numbers in ascending order.
Constraints:1 ≤ arr.size() ≤ 1050 ≤ arri ≤ 109